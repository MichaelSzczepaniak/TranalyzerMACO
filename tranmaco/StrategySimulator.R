...
##
## priceSignalsAction - dataframe that must contain the 2 columns/fields:
## 1) column with name specified in calcCol
## 2) Action
## startAmt - starting account balance used in simulation
## calcCol - column name in priceSignalsAction to base signal calc's upon
